...
- `.hermes/skills/reservoir-engineering/SKILL.md`
- `.hermes/skills/run-tests/SKILL.md`

## Prompt

```text
/skill reservoir-engineering
...
After the checklist is drafted, ask Hermes to turn it into a reusable deliverable:
