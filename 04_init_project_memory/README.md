...
**Best practice:** put recurring project context in `CLAUDE.md` / `AGENTS.md` so every Hermes session starts with the same engineering rules.
...
After Hermes creates or updates `CLAUDE.md`, refine it with reservoir engineering rules:
